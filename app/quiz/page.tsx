...
const STATUS_CONFIG = {
  waiting: {
    label: "Waiting",
    color: "bg-primary/10 text-primary dark:text-primary border-primary dark:border-primary/20",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-white dark:bg-slate-900 border hover:border-primary dark:hover:border-primary/40 hover:-translate-y-0.5 shadow-sm hover:shadow-md",
        isLive
    ...
    >
      ...
      <div className="relative h-28 overflow-hidden">
        ...
        <div className="absolute top-3 right-3 flex items-center gap-2">
          {quiz.isAiGenerated && (
            <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-bold bg-primary/10 text-primary border border-primary/20 backdrop-blur">
        ...
        {quiz.reward && quiz.reward.poolAmount > 0 && (
          <div className="absolute bottom-3 right-3">
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold bg-primary/10 text-primary border border-primary/20 backdrop-blur">
      ...
      <div className="p-4 space-y-3">
        <div>
          <h3 className="font-bold text-slate-900 dark:text-white text-sm leading-tight group-hover:text-primary dark:group-hover:text-primary transition-colors line-clamp-2">
            {quiz.title}
          </h3>
          {quiz.description && (
        ...
        <div className="flex items-center gap-3 text-xs text-slate-400 dark:text-slate-500">
          ...
          {quiz.reward && (
            <span className="flex items-center gap-1">
              <Trophy className="h-3 w-3 text-primary" /> {quiz.reward.totalWinners}W
            </span>
          )}
        ...
        <div className="flex items-center justify-between pt-1 border-t border-slate-100 dark:border-white/[0.06]">
          ...
          <span className={cn(
            ...
            isFull
              ...
              ? "text-slate-300 dark:text-white/20"
              : "text-primary dark:text-primary group-hover:text-primary dark:group-hover:text-primary"
          )}>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="space-y-3 flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-primary dark:bg-primary/10 border border-primary dark:border-primary/20 flex items-center justify-center shrink-0">
                  <Gamepad2 className="h-4 w-4 text-primary dark:text-primary" />
                </div>
                <span className="text-primary dark:text-primary font-bold text-xs uppercase tracking-widest">Z-clash Quiz</span>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-1">
                ...
                {waitingCount > 0 && (
                  <span className="flex items-center gap-2 text-primary dark:text-primary text-sm font-bold">
            ...
            <div className="w-full lg:w-auto shrink-0 space-y-2 lg:min-w-[260px]">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button
                  className="h-11 px-4 font-bold bg-primary hover:bg-primary text-white border-0 shrink-0"
              ...
              <Button
                ...
                className="w-full h-11 bg-primary hover:bg-primary text-white font-bold border-0 mt-1"
              >
        ...
        {isLoading ? (
          ...
          <div className="border border-dashed border-slate-200 dark:border-white/[0.07] rounded-2xl flex flex-col items-center justify-center py-24 space-y-4">
            ...
            {userWalletAddress && (
              <Button
                onClick={() => router.push("/quiz/create-quiz")}
                className="bg-primary hover:bg-primary text-white font-bold border-0"
              >
                <Plus className="mr-2 h-4 w-4" /> Create Quiz
              </Button>
            )}
