...
/**
 * /app/page.tsx — DropDuel Landing (Rebranded to Z-clash)
        ...
        <nav className="r r1 flex items-center justify-between px-6 pt-8 pb-6">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 relative flex items-center justify-center">
              <Image src="/logo.png" alt="Z-clash Light Logo" width={32} height={32} className="logo-light" priority />
              <Image src="/logo.png" alt="Z-clash Dark Logo" width={32} height={32} className="logo-dark" priority />
            </div>
